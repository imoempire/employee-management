...
import { HandheldFolderVideosResponse, Video } from "../../_components/types";
...
export default function Page() {
  ...
  const {
    ...
    // refetch,
    isLoading,
  } = useCustomGet<HandheldFolderVideosResponse>({
    url: `https://erp.mawuena.com/api/admin/handheld-folder/${params.id}/videos`,
  });
